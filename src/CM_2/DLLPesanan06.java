...
public class DLLPesanan06 {
    ...
    // Method isEmpty digunakan untuk memeriksa apakah linkedlist kosong atau tidak
    boolean isEmpty() {
        return head == null;
    }

    // method addLast digunakan untuk menambahkan pesanan baru ke akhir linked list
        ...
        do {
            ...
            while (current.next != null) {
                ...
                if (current.data.namaPesanan
                    ...
                    Pesanan06 sementara =current.data;
    ...
    // method menghapus pesanan berdasarkan kode pesanan
    public void batalkanPesanan(int kode) {
        ...
        // mencari node dengan kode pesanan yang sesuai
        while (temp != null) {

            if (temp.data.kodePesanan == kode) {
                ...
                System.out.println("Pesanan dengan kode " + kode + " berhasil dibatalkan");
                return;
            }
